...
local v466 = loadstring(game:HttpGet("https://raw.githubusercontent.com/enzoplaaygamemg12/RedzhubUiRedux/refs/heads/main/RedzHubUiLib.lua"))():MakeWindow({
    Title = "Notz Hub",
    SubTitle = "by Minh_Đaiz",
...
l_ImageButton_0.Image = "rbxassetid://121087197254040"
...
v484:AddDiscordInvite({
    ...
    Logo = "rbxassetid://121087197254040",
    Invite = "https://discord.gg/yZNteKpr8"
})
v484:AddDiscordInvite({
    Name = "MinhDaiDz",
    Description = "Facebook",
    Logo = "rbxassetid://121087197254040",
    Invite = "https://www.facebook.com/share/1HPja7mWfQ/"
})
v484:AddDiscordInvite({
    Name = "MinhDaiDz",
    Description = "YouTube",
    Logo = "rbxassetid://121087197254040",
    Invite = "https://youtube.com/@runo_officiall?si=m1OVmzbAhm0kesD0"
})
v484:AddDiscordInvite({
    Name = "MinhDaiDz",
    Description = "TikTok",
    Logo = "rbxassetid://121087197254040",
    Invite = "https://www.tiktok.com/@xsmobie999?_r=1&_t=ZS-930L6TJZBIL"
})
...
if World2 then
    ...
    v487:AddToggle({
        Name = "Auto làm nhiệm vụ Bartilo",
    ...
    v487:AddToggle({
        Name = "Đánh thuyền trưởng nguyền rủa",
    ...
    local _ = v487:AddSection({"Auto Buy Haki M\195\160u"})
    v487:AddToggle({
        Name = "mua Haki",
    ...
    v487:AddToggle({
        Name = "Auto lấy kiếm Dragon Trident",
                                    ...
                                    if not l_Character_7:FindFirstChild("Tushita") and not l_Backpack_1:FindFirstChild("Tushita") then
                                        if not v798 then
                                            game.StarterGui:SetCore("SendNotification", {
                                                ...
                                                con = "rbxassetid://121087197254040",
                                                Duration = 10
                                            })
                                            v798 = true
                                        end
...
v488:AddToggle({
    Name = "Auto treo đảo Prehistoric",
...
v488:AddToggle({
    Name = "Auto đến Prehistoric Island",
...
local _ = v493:AddSection({"Teleport Sea | Di Chuy\225\187\131n Sea 1,2,3"})
v493:AddButton({
    Name = "Sea 1",
...
local _ = v494:AddSection({"Teleport Player | Di Chuy\225\187\131n \196\144\225\186\191n Player"})
local v1123 = {}
...
local _ = v494:AddSection({"Esp | \196\144\225\187\139nh V\225\187\139..."})
v494:AddToggle({
    Title = "Esp Players",
    Value = false,
...
v496:AddParagraph({Title = "Unban Fast Attack - M1 Fruit", Content = "On: \226\156\133"})
...
v496:AddToggle({Title = "Đứng trên nước", Value = true, Callback = function(v1188)
    _G.WalkWater = v1188
end})
spawn(function()
    while task.wait() do
